...
import models.inception_v4 as inception_v4
import models.inception_resnet_v1 as inception_resnet_v1
import models.inception_resnet_v2 as inception_resnet_v2
...
if __name__ == '__main__':
    ...
    res_loss = dict()
    res_acc = dict()
    for name in ['inception_resnet_v2', 'inception_resnet_v1', 'inception_v4']:
        if name == 'inception_v4':
            model = inception_v4.Inception_v4(num_classes=20)
        elif name == 'inception_resnet_v1':
            model = inception_resnet_v1.Inception_ResNet_v1(num_classes=20)
        else:
            model = inception_resnet_v2.Inception_ResNet_v2(num_classes=20)
        model.eval()
        # print(model)
